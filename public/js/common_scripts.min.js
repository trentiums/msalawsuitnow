!(function (t, e) {
            ...
            return (
                (t.toggle = function () {
                    ...
                    ((t = this._element.querySelector(v)) &&
                        ("radio" === t.type && (t.checked && this._element.classList.contains(p) ? (i = !1) : (e = n.querySelector(".active")) && f(e).removeClass(p)),
                        i && (("checkbox" !== t.type && "radio" !== t.type) || (t.checked = !this._element.classList.contains(p)), f(t).trigger("change")),
                            t.focus(),
                            (s = !1))),
                    this._element.hasAttribute("disabled") || this._element.classList.contains("disabled") || (s && this._element.setAttribute("aria-pressed", !this._element.classList.contains(p)), i && f(this._element).toggleClass(p));
                }),
                    (t.dispose = function () {
    ...
    f(document)
        .on("click.bs.button.data-api", m, function (t) {
            var e = t.target,
                i = e;
            if ((f(e).hasClass("btn") || (e = f(e).closest(_)[0]), !e || e.hasAttribute("disabled") || e.classList.contains("disabled"))) t.preventDefault();
            else {
        ...
        (f.fn[c] = b._jQueryInterface),
        (f.fn[c].Constructor = b),
            ...
            return (
                (t.next = function () {
                    ...
                    (t._slide = function (t, e) {
                        ...
                        c && f(c).hasClass(T)
                            ? (this._isSliding = !1)
                            : this._triggerSlideEvent(c, p).isDefaultPrevented() ||
                            (l &&
                                c &&
                                ((this._isSliding = !0),
                                d && this.pause(),
                                    this._setActiveIndicatorElement(c),
                                    (n = f.Event(I, { relatedTarget: c, direction: p, from: h, to: u })),
                                    f(this._element).hasClass("slide")
                                        ...
                                        : (f(l).removeClass(T), f(c).addClass(T), (this._isSliding = !1), f(this._element).trigger(n)),
                                d && this.cycle()));
                    }),
                    (o._jQueryInterface = function (s) {
                        return this.each(function () {
                            ...
                            if ((t || ((t = new o(this, e)), f(this).data(w, t)), "number" == typeof s)) t.to(s);
                    ...
                    (o._dataApiClickHandler = function (t) {
                        ...
                        ((e = f(n)[0]) &&
                            ...
                            ((i = l({}, f(e).data(), f(this).data())), (s = this.getAttribute("data-slide-to")) && (i.interval = !1), o._jQueryInterface.call(f(e), i), s && f(e).data(w).to(s), t.preventDefault()));
                    }),
                    r(o, null, [
                        {
                            key: "VERSION",
    ...
    f(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", P._dataApiClickHandler),
            ...
            return (
                (t.toggle = function () {
                    ...
                    (t.show = function () {
                        ...
                        (t = null),
                        (t && (e = f(t).not(this._selector).data(N)) && e._isTransitioning) ||
                        ((i = f.Event("show.bs.collapse")),
                            f(this._element).trigger(i),
                        i.isDefaultPrevented() ||
                        (t && (a._jQueryInterface.call(f(t).not(this._selector), "hide"), e || f(t).data(N, null)),
                            (s = this._getDimension()),
                            f(this._element).removeClass(R).addClass(W),
                            (this._element.style[s] = 0),
                        this._triggerArray.length && f(this._triggerArray).removeClass(j).attr("aria-expanded", !0),
                            this.setTransitioning(!0),
                            (n = "scroll" + (s[0].toUpperCase() + s.slice(1))),
                            ...
                            f(this._element)
                                .one(g.TRANSITION_END, function () {
                                    f(r._element)
                                        ...
                                        f(r._element).trigger("shown.bs.collapse");
                                })
                    ...
                    (a._jQueryInterface = function (s) {
                        return this.each(function () {
                            var t = f(this),
                                e = t.data(N),
                                i = l({}, z, t.data(), "object" == typeof s && s ? s : {});
    ...
    f(document).on("click.bs.collapse.data-api", $, function (t) {
        ...
        f(s).each(function () {
            var t = f(this),
                e = t.data(N) ? "toggle" : i.data();
            q._jQueryInterface.call(t, e);
        });
    }),
        (f.fn[M] = q._jQueryInterface),
        (f.fn[M].Constructor = q),
    ...
    function rt(t, e, i, s) {
        return Math.max(
            ...
            i["offset" + t],
            i["scroll" + t],
            tt(10) ? parseInt(i["offset" + t]) + parseInt(s["margin" + ("Height" === t ? "Top" : "Left")]) + parseInt(s["margin" + ("Height" === t ? "Bottom" : "Right")]) : 0
        );
    }
    function at(t) {
        var e = t.body,
            i = t.documentElement,
            s = tt(10) && getComputedStyle(i);
    ...
    function ft(t) {
        ...
        var n,
            o = { left: s.left, top: s.top, width: s.right - s.left, height: s.bottom - s.top },
            r = "HTML" === t.nodeName ? at(t.ownerDocument) : {},
    ...
    function gt(t, e, i) {
        ...
        var d,
            p,
            f = pt({ top: r.top - a.top - c, left: r.left - a.left - u, width: r.width, height: r.height });
        return (
            (f.marginTop = 0),
                (f.marginLeft = 0),
            !n && o && ((d = parseFloat(h.marginTop)), (p = parseFloat(h.marginLeft)), (f.top -= c - d), (f.bottom -= c - d), (f.left -= u - p), (f.right -= u - p), (f.marginTop = d), (f.marginLeft = p)),
    ...
    function vt(t, e, i, s, n) {
        ...
        "viewport" === s
            ...
            : ((o = void 0),
                "scrollParent" === s ? "BODY" === (o = X(K(e))).nodeName && (o = t.ownerDocument.documentElement) : (o = "window" === s ? t.ownerDocument.documentElement : s),
                (r = gt(o, d, c)),
                "HTML" !== o.nodeName ||
                (function t(e) {
                    var i = e.nodeName;
                    ...
                    ? (u = r)
                    : ((l = (a = at(t.ownerDocument)).height), (h = a.width), (u.top += r.top - r.marginTop), (u.bottom = l + r.top), (u.left += r.left - r.marginLeft), (u.right = h + r.left)));
    ...
    function Pt(t, e) {
        ...
        var s = t.offsets,
            ...
            d = e ? (c || u || l % 2 == h % 2 ? r : a) : i,
            p = e ? r : i;
        return { left: d(l % 2 == 1 && h % 2 == 1 && !u && e ? n.left - 1 : n.left), top: p(n.top), bottom: p(n.bottom), right: d(n.right) };
    }
    ...
    function jt(t, n, o, e) {
        ...
        var l = /\s*,\s*|\s+/;
        return (
            (-1 !== s ? [i.slice(0, s).concat([i[s].split(l)[0]]), [i[s].split(l)[1]].concat(i.slice(s + 1))] : [i])
                .map(function (t, e) {
                    ...
                    fn: function (t) {
                        ...
                        return (
                            ...
                            ((i = (e = t.offsets).reference),
                                (s = e.popper),
                                (r = (n = -1 !== ["bottom", "top"].indexOf(h)) ? "width" : "height"),
                                (a = { start: ut({}, (o = n ? "left" : "top"), i[o]), end: ut({}, o, i[o] + i[r] - s[r]) }),
                                (t.offsets.popper = dt({}, s, a[c]))),
                                t
                        );
                    },
                },
                        ...
                        return (
                            C.forEach(function (t, e) {
                                ...
                                g && (w = "end" === (i = w) ? "start" : "start" === i ? "end" : i),
                                    (m.placement = b + (w ? "-" + w : "")),
                                    (m.offsets.popper = dt({}, m.offsets.popper, Ct(m.instance.popper, m.offsets.reference, m.placement))),
                                    (m = kt(m.instance.modifiers, m, "flip")));
                            }),
                                m
                        );
                    },
                ...
                hide: {
                    ...
                    fn: function (t) {
                        ...
                        var e = t.offsets.reference,
                            i = xt(t.instance.modifiers, function (t) {
                ...
                computeStyle: {
                    ...
                    fn: function (t, e) {
                        var i = e.x,
                            s = e.y,
                            n = t.offsets.popper,
                            o = xt(t.instance.modifiers, function (t) {
                        ...
                        var r,
                            ...
                            h = et(t.instance.popper),
                            c = ft(h),
                            u = { position: n.position },
                            d = Pt(t, window.devicePixelRatio < 2 || !Mt),
                        ...
                        l && g
                            ? ((u[g] = "translate3d(" + m + "px, " + v + "px, 0)"), (u[p] = 0), (u[f] = 0), (u.willChange = "transform"))
                            : ((r = "bottom" == p ? -1 : 1), (a = "right" == f ? -1 : 1), (u[p] = v * r), (u[f] = m * a), (u.willChange = p + ", " + f));
                ...
                applyStyle: {
                    ...
                    fn: function (t) {
                        ...
                        return (
                            ...
                            t.arrowElement && Object.keys(t.arrowStyles).length && At(t.arrowElement, t.arrowStyles),
                                t
                        );
                    },
            ...
            (ht(Bt, [
                {
                    ...
                    value: function () {
                        return function () {
                            ...
                            (((t = { instance: this, styles: {}, arrowStyles: {}, attributes: {}, flipped: !1, offsets: {} }).offsets.reference = bt(this.state, this.popper, this.reference, this.options.positionFixed)),
                                (t.placement = _t(this.options.placement, t.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding)),
                                (t.originalPlacement = t.placement),
                                (t.positionFixed = this.options.positionFixed),
                                (t.offsets.popper = Ct(this.popper, t.offsets.reference, t.placement)),
                                (t.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute"),
                                (t = kt(this.modifiers, t)),
    ...
    function Bt(t, e) {
        ...
        lt(this, Bt),
            ...
            (this.options = dt({}, Bt.Defaults, s)),
            (this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }),
            (this.reference = t && t.jquery ? t[0] : t),
            (this.popper = e && e.jquery ? e[0] : e),
            (this.options.modifiers = {}),
            Object.keys(dt({}, Bt.Defaults.modifiers, s.modifiers)).forEach(function (t) {
            ...
            return (
                (t.toggle = function () {
                        ...
                        if ((void 0 === t && (t = !1), !(this._element.disabled || f(this._element).hasClass(ee) || f(this._menu).hasClass(ie)))) {
                            ...
                            if ((f(s).trigger(i), !i.isDefaultPrevented())) {
                                if (!this._inNavbar && t) {
                                    ...
                                    var n = this._element;
                                    "parent" === this._config.reference ? (n = s) : g.isElement(this._config.reference) && ((n = this._config.reference), void 0 !== this._config.reference.jquery && (n = this._config.reference[0])),
                                    "scrollParent" !== this._config.boundary && f(s).addClass("position-static"),
                                        (this._popper = new qt(n, this._menu, this._getPopperConfig()));
                                }
                                "ontouchstart" in document.documentElement && 0 === f(s).closest(".navbar-nav").length && f(document.body).children().on("mouseover", null, f.noop),
                                    this._element.focus(),
                                    this._element.setAttribute("aria-expanded", !0),
                                    f(this._menu).toggleClass(ie),
                                    f(s).toggleClass(ie).trigger(f.Event("shown.bs.dropdown", e));
                            }
                        }
                    }),
                    (t.hide = function () {
                        ...
                        f(this._element).hasClass(ee) ||
                        !f(this._menu).hasClass(ie) ||
                        ((t = { relatedTarget: this._element }),
                            (e = f.Event(Gt, t)),
                            (i = h._getParentFromElement(this._element)),
                            f(i).trigger(e),
                        e.isDefaultPrevented() || (this._popper && this._popper.destroy(), f(this._menu).toggleClass(ie), f(i).toggleClass(ie).trigger(f.Event(Zt, t))));
                    }),
                    (t.dispose = function () {
                    ...
                    (t._getPlacement = function () {
                        ...
                        return (
                            t.hasClass("dropup")
                                ? (e = f(this._menu).hasClass(se) ? "top-end" : "top-start")
                                : t.hasClass("dropright")
                                    ? (e = "right-start")
                                    : t.hasClass("dropleft")
                                        ? (e = "left-start")
                                        : f(this._menu).hasClass(se) && (e = "bottom-end"),
                                e
                        );
                    }),
                    ...
                    (h._clearMenus = function (t) {
                        if (!t || (3 !== t.which && ("keyup" !== t.type || 9 === t.which)))
                            for (var e = [].slice.call(document.querySelectorAll(ne)), i = 0, s = e.length; i < s; i++) {
                                var n,
                                    o,
                                    r = h._getParentFromElement(e[i]),
                                    a = f(e[i]).data(Qt),
                                    l = { relatedTarget: e[i] };
                                ...
                                ((n = a._menu),
                                f(r).hasClass(ie) &&
                                ((t && (("click" === t.type && /input|textarea/i.test(t.target.tagName)) || ("keyup" === t.type && 9 === t.which)) && f.contains(r, t.target)) ||
                                    ((o = f.Event(Gt, l)),
                                        f(r).trigger(o),
                                    ...
                                    a._popper && a._popper.destroy(),
                                        f(n).removeClass(ie),
                                        f(r).removeClass(ie).trigger(f.Event(Zt, l))))));
                            }
                    }),
                    ...
                    (h._dataApiKeydownHandler = function (t) {
                        if (
                            (/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || (27 !== t.which && ((40 !== t.which && 38 !== t.which) || f(t.target).closest(oe).length))) : Xt.test(t.which)) &&
                            !this.disabled &&
                            !f(this).hasClass(ee)
                        ) {
    ...
    f(document)
        .on(te, ne, le._dataApiKeydownHandler)
        .on(te, oe, le._dataApiKeydownHandler)
        .on(Jt + " keyup.bs.dropdown.data-api", le._clearMenus)
        .on(Jt, ne, function (t) {
        ...
        (f.fn[Yt] = le._jQueryInterface),
        (f.fn[Yt].Constructor = le),
        (f.fn[Yt].noConflict = function () {
            ...
            return (
                (t.toggle = function (t) {
                    ...
                    (t.show = function (t) {
                        ...
                        this._isShown ||
                        this._isTransitioning ||
                        (f(this._element).hasClass(xe) && (this._isTransitioning = !0),
                            (e = f.Event(me, { relatedTarget: t })),
                        ...
                        ((this._isShown = !0),
                            ...
                            f(this._element).on(be, '[data-dismiss="modal"]', function (t) {
                                return i.hide(t);
                            }),
                    ...
                    (t.hide = function (t) {
                        ...
                        !e.isDefaultPrevented() &&
                        ((this._isShown = !1),
                        (i = f(this._element).hasClass(xe)) && (this._isTransitioning = !0),
                            this._setEscapeEvent(),
                            this._setResizeEvent(),
                            f(document).off(ve),
                            f(this._element).removeClass(ke),
                            f(this._element).off(be),
                            f(this._dialog).off(we),
                            i
                    ...
                    (t._triggerBackdropTransition = function () {
                        ...
                        if ("static" === this._config.backdrop) {
                            ...
                            f(this._element).off(g.TRANSITION_END),
                                f(this._element)
                                    .one(g.TRANSITION_END, function () {
                    ...
                    (t._showElement = function (t) {
                        ...
                        (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE) || document.body.appendChild(this._element),
                            ...
                            f(this._dialog).hasClass("modal-dialog-scrollable") && s ? (s.scrollTop = 0) : (this._element.scrollTop = 0),
                        i && g.reflow(this._element),
                            f(this._element).addClass(ke),
                    ...
                    (t._setEscapeEvent = function () {
                        var e = this;
                        this._isShown
                            ? f(this._element).on(ye, function (t) {
                    ...
                    (t._showBackdrop = function (t) {
                        var e,
                            i,
                            s = this,
                            n = f(this._element).hasClass(xe) ? xe : "";
                        if (this._isShown && this._config.backdrop) {
                            if (
                                ...
                                n && this._backdrop.classList.add(n),
                                    ...
                                    f(this._element).on(be, function (t) {
                            ...
                            !this._isShown && this._backdrop
                                ? (f(this._backdrop).removeClass(ke),
                                    (e = function () {
                                        s._removeBackdrop(), t && t();
                                    }),
                                    f(this._element).hasClass(xe) ? ((i = g.getTransitionDurationFromElement(this._backdrop)), f(this._backdrop).one(g.TRANSITION_END, e).emulateTransitionEnd(i)) : e())
                                : t && t();
                        }
                    }),
                    ...
                    (n._jQueryInterface = function (i, s) {
                        return this.each(function () {
                            var t = f(this).data(ce),
                                e = l({}, pe, f(this).data(), "object" == typeof i && i ? i : {});
    ...
    f(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function (t) {
        ...
        (f.fn[he] = Ie._jQueryInterface),
        (f.fn[he].Constructor = Ie),
        ...
        Xe = (function () {
            ...
            return (
                (t.enable = function () {
                    ...
                    (t.show = function () {
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            f.contains(this.element.ownerDocument.documentElement, this.tip) || f(n).appendTo(l),
                                ...
                                (this._popper = new qt(this.element, n, this._getPopperConfig(a))),
                                f(n).addClass(Ue),
                    ...
                    (t.hide = function (t) {
                        function e() {
                            s._hoverState !== Be && n.parentNode && n.parentNode.removeChild(n),
                                s._cleanTipClass(),
                        ...
                        "ontouchstart" in document.documentElement && f(document.body).children().off("mouseover", null, f.noop),
                            ...
                            f(this.tip).hasClass(Qe) ? ((i = g.getTransitionDurationFromElement(n)), f(n).one(g.TRANSITION_END, e).emulateTransitionEnd(i)) : e(),
                            (this._hoverState = ""));
                    }),
                    (t.update = function () {
                    ...
                    (t.setElementContent = function (t, e) {
                        "object" != typeof e || (!e.nodeType && !e.jquery)
                            ? this.config.html
                                ? (this.config.sanitize && (e = Me(e, this.config.whiteList, this.config.sanitizeFn)), t.html(e))
                                : t.text(e)
                            : this.config.html
                    ...
                    (t._setListeners = function () {
                        ...
                        this.config.trigger.split(" ").forEach(function (t) {
                            var e, i;
                            "click" === t
                                ? f(s.element).on(s.constructor.Event.CLICK, s.config.selector, function (t) {
                                    return s.toggle(t);
                                })
                                : "manual" !== t &&
                                ((e = t === Ve ? s.constructor.Event.MOUSEENTER : s.constructor.Event.FOCUSIN),
                                    (i = t === Ve ? s.constructor.Event.MOUSELEAVE : s.constructor.Event.FOCUSOUT),
                                    f(s.element)
                    ...
                    (t._enter = function (t, e) {
                        ...
                        t && (e._activeTrigger["focusin" === t.type ? Ke : Ve] = !0),
                            f(e.getTipElement()).hasClass(Ue) || e._hoverState === Be
                                ? (e._hoverState = Be)
                    ...
                    (t._leave = function (t, e) {
                        var i = this.constructor.DATA_KEY;
                        (e = e || f(t.currentTarget).data(i)) || ((e = new this.constructor(t.currentTarget, this._getDelegateConfig())), f(t.currentTarget).data(i, e)),
                        t && (e._activeTrigger["focusout" === t.type ? Ke : Ve] = !1),
                    ...
                    (t._getConfig = function (t) {
                        ...
                        return (
                            ...
                            "number" == typeof t.content && (t.content = t.content.toString()),
                                g.typeCheckConfig(Ne, t, this.constructor.DefaultType),
                            t.sanitize && (t.template = Me(t.template, t.whiteList, t.sanitizeFn)),
                                t
                        );
                    }),
    ...
    (f.fn[Ne] = Xe._jQueryInterface),
        (f.fn[Ne].Constructor = Xe),
        (f.fn[Ne].noConflict = function () {
    ...
    var Ge = "popover",
        ...
        ti = f.fn[Ge],
        ei = "bs-popover",
        ii = new RegExp("(^|\\s)" + ei + "\\S+", "g"),
        si = l({}, Xe.Default, { placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>' }),
        ni = l({}, Xe.DefaultType, { content: "(string|element|function)" }),
        oi = {
            HIDE: "hide" + Je,
            HIDDEN: "hidden" + Je,
            SHOW: "show" + Je,
    ...
    (f.fn[Ge] = ri._jQueryInterface),
        (f.fn[Ge].Constructor = ri),
        (f.fn[Ge].noConflict = function () {
    ...
    var ai = "scrollspy",
        ...
        _i = (function () {
            ...
            return (
                (t.refresh = function () {
                    var e = this,
                        t = this._scrollElement === this._scrollElement.window ? "offset" : vi,
                    ...
                    (t._getConfig = function (t) {
                        var e;
                        return (
                            "string" != typeof (t = l({}, ui, "object" == typeof t && t ? t : {})).target && g.isElement(t.target) && ((e = f(t.target).attr("id")) || ((e = g.getUID(ai)), f(t.target).attr("id", e)), (t.target = "#" + e)),
                                g.typeCheckConfig(ai, t, di),
                                t
                        );
                    }),
                    ...
                    (t._activate = function (e) {
                        ...
                        i.hasClass("dropdown-item")
                            ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(pi), i.addClass(pi))
                            : (i.addClass(pi),
                                i
                                    .parents(fi)
                                    .prev(gi + ", " + mi)
                                    .addClass(pi),
                                i.parents(fi).prev(".nav-item").children(gi).addClass(pi)),
            ...
            return (
                (t.show = function () {
                    var t,
                        ...
                        a,
                        l = this;
                    (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && f(this._element).hasClass(wi)) ||
                    f(this._element).hasClass("disabled") ||
                    ((e = f(this._element).closest(".nav, .list-group")[0]),
                        (i = g.getSelectorFromElement(this._element)),
                    e && ((s = "UL" === e.nodeName || "OL" === e.nodeName ? xi : Ci), (n = (n = f.makeArray(f(e).find(s)))[n.length - 1])),
                        (o = f.Event("hide.bs.tab", { relatedTarget: this._element })),
                        (r = f.Event("show.bs.tab", { relatedTarget: n })),
                    n && f(n).trigger(o),
                    ...
                    (t._transitionComplete = function (t, e, i) {
                        var s, n, o;
                        e && (f(e).removeClass(wi), (s = f(e.parentNode).find("> .dropdown-menu .active")[0]) && f(s).removeClass(wi), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1)),
                            f(t).addClass(wi),
                        ...
                        ((n = f(t).closest(".dropdown")[0]) && ((o = [].slice.call(n.querySelectorAll(".dropdown-toggle"))), f(o).addClass(wi)), t.setAttribute("aria-expanded", !0)),
                        i && i();
                    }),
                    (s._jQueryInterface = function (i) {
                        return this.each(function () {
    ...
    f(document).on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function (t) {
        ...
        (f.fn.tab = ki._jQueryInterface),
        (f.fn.tab.Constructor = ki),
            ...
            return (
                (t.show = function () {
                    ...
                    this._config.animation && this._element.classList.add("fade"),
                        (t = function () {
                            i._element.classList.remove(Ai),
                                i._element.classList.add(Fi),
                        ...
                        this._config.animation ? ((e = g.getTransitionDurationFromElement(this._element)), f(this._element).one(g.TRANSITION_END, t).emulateTransitionEnd(e)) : t());
                }),
                    (t.hide = function () {
                        var t;
    ...
    (f.fn[Di] = Ni._jQueryInterface),
        (f.fn[Di].Constructor = Ni),
    ...
    (function (r) {
        ...
        r.cleanData
            ...
            (r.widget = function (e, t, i) {
                ...
                var o = new t();
                (o.options = r.extend(!0, {}, o.options)),
                    (r[s][e].prototype = r.extend(!0, o, { namespace: s, widgetName: e, widgetEventPrefix: r[s][e].prototype.widgetEventPrefix || e, widgetBaseClass: n }, i)),
                    r.widget.bridge(e, r[s][e]);
            }),
    ...
    (function (b) {
        b.widget("ui.draggable", b.ui.mouse, {
            ...
            _mouseStop: function (t) {
                ...
                return (
                    (n || "original" !== this.options.helper) &&
                    (("invalid" == this.options.revert && !e) || ("valid" == this.options.revert && e) || !0 === this.options.revert || (b.isFunction(this.options.revert) && this.options.revert.call(this.element, e))
                        ? b((i = this).helper).animate(this.originalPosition, parseInt(this.options.revertDuration, 10), function () {
            ...
            _generatePosition: function (t) {
                ...
                return (
                    ...
                    (this.containment &&
                    ((i = this.relative_container
                        ? ((e = this.relative_container.offset()), [this.containment[0] + e.left, this.containment[1] + e.top, this.containment[2] + e.left, this.containment[3] + e.top])
                        : this.containment),
                    ...
                    o.grid &&
                    ((s = o.grid[1] ? this.originalPageY + Math.round((h - this.originalPageY) / o.grid[1]) * o.grid[1] : this.originalPageY),
                        (h = i && (s - this.offset.click.top < i[1] || s - this.offset.click.top > i[3]) ? (s - this.offset.click.top < i[1] ? s + o.grid[1] : s - o.grid[1]) : s),
                        (n = o.grid[0] ? this.originalPageX + Math.round((l - this.originalPageX) / o.grid[0]) * o.grid[0] : this.originalPageX),
                        (l = i && (n - this.offset.click.left < i[0] || n - this.offset.click.left > i[2]) ? (n - this.offset.click.left < i[0] ? n + o.grid[0] : n - o.grid[0]) : n))),
                        {
                            top:
                                h -
                                ...
                                (b.browser.safari && b.browser.version < 526 && "fixed" == this.cssPosition ? 0 : "fixed" == this.cssPosition ? -this.scrollParent.scrollTop() : a ? 0 : r.scrollTop()),
                            left:
                                l -
                                this.offset.click.left -
                                this.offset.relative.left -
                                this.offset.parent.left +
                                (b.browser.safari && b.browser.version < 526 && "fixed" == this.cssPosition ? 0 : "fixed" == this.cssPosition ? -this.scrollParent.scrollLeft() : a ? 0 : r.scrollLeft()),
                        }
                );
            },
            _clear: function () {
                ...
                drag: function (t, e) {
                    for (
                        ...
                        var c,
                            ...
                            p,
                            f,
                            g = i.snapElements[h].left,
                            m = g + i.snapElements[h].width,
                            v = i.snapElements[h].top,
                            _ = v + i.snapElements[h].height;
                        (g - n < o && o < m + n && v - n < a && a < _ + n) || (g - n < o && o < m + n && v - n < l && l < _ + n) || (g - n < r && r < m + n && v - n < a && a < _ + n) || (g - n < r && r < m + n && v - n < l && l < _ + n)
                            ? ("inner" != s.snapMode &&
                            ((u = Math.abs(v - l) <= n),
                                (d = Math.abs(_ - a) <= n),
                                (p = Math.abs(g - r) <= n),
                                (f = Math.abs(m - o) <= n),
                            u && (e.position.top = i._convertPositionTo("relative", { top: v - i.helperProportions.height, left: 0 }).top - i.margins.top),
                            d && (e.position.top = i._convertPositionTo("relative", { top: _, left: 0 }).top - i.margins.top),
                            p && (e.position.left = i._convertPositionTo("relative", { top: 0, left: g - i.helperProportions.width }).left - i.margins.left),
                            f && (e.position.left = i._convertPositionTo("relative", { top: 0, left: m }).left - i.margins.left)),
                                (c = u || d || p || f),
                            "outer" != s.snapMode &&
                            ((u = Math.abs(v - a) <= n),
                                (d = Math.abs(_ - l) <= n),
                                (p = Math.abs(g - o) <= n),
                                (f = Math.abs(m - r) <= n),
                            u && (e.position.top = i._convertPositionTo("relative", { top: v, left: 0 }).top - i.margins.top),
                            d && (e.position.top = i._convertPositionTo("relative", { top: _ - i.helperProportions.height, left: 0 }).top - i.margins.top),
                            p && (e.position.left = i._convertPositionTo("relative", { top: 0, left: g }).left - i.margins.left),
                            f && (e.position.left = i._convertPositionTo("relative", { top: 0, left: m - i.helperProportions.width }).left - i.margins.left)),
                            !i.snapElements[h].snapping && (u || d || p || f || c) && i.options.snap.snap && i.options.snap.snap.call(i.element, t, b.extend(i._uiHash(), { snapItem: i.snapElements[h].item })),
                                (i.snapElements[h].snapping = u || d || p || f || c))
                            : (i.snapElements[h].snapping && i.options.snap.release && i.options.snap.release.call(i.element, t, b.extend(i._uiHash(), { snapItem: i.snapElements[h].item })), (i.snapElements[h].snapping = !1));
                    }
                },
            }),
                ...
                drag: function (n, o) {
                    n.options.refreshPositions && p.ui.ddmanager.prepareOffsets(n, o),
                        p.each(p.ui.ddmanager.droppables[n.options.scope] || [], function () {
                            ...
                            this.greedyChild ||
                            !this.visible ||
                            ((e = (t = p.ui.intersect(n, this, this.options.tolerance)) || 1 != this.isover ? (t && 0 == this.isover ? "isover" : null) : "isout") &&
                                (!this.options.greedy || ((s = this.element.parents(":data(droppable):eq(0)")).length && ((i = p.data(s[0], "droppable")).greedyChild = "isover" == e ? 1 : 0)),
    ...
    (function (f) {
        f.widget("ui.resizable", f.ui.mouse, {
            ...
            _create: function () {
                ...
                (this._renderAxis = function (t) {
                    for (var e in ((t = t || this.element), this.handles)) {
                        var i, s, n;
                        this.handles[e].constructor == String && (this.handles[e] = f(this.handles[e], this.element).show()),
                        this.elementIsWrapper &&
                        this.originalElement[0].nodeName.match(/textarea|input|select|button/i) &&
                        ((i = f(this.handles[e], this.element)),
            ...
            destroy: function () {
                ...
                return (
                    this.elementIsWrapper &&
                    (t(this.element), (e = this.element).after(this.originalElement.css({ position: e.css("position"), width: e.outerWidth(), height: e.outerHeight(), top: e.css("top"), left: e.css("left") })).remove()),
            ...
            _mouseStop: function (t) {
                ...
                return (
                    this._helper &&
                    ((s = (i = (e = this._proportionallyResizeElements).length && /textarea/i.test(e[0].nodeName)) && f.ui.hasScroll(e[0], "left") ? 0 : h.sizeDiff.height),
                    ...
                    l.animate || this.element.css(f.extend(o, { top: a, left: r })),
            ...
            _updateVirtualBoundaries: function (t) {
                var e,
                    ...
                    n,
                    o = this.options,
                    r = { minWidth: p(o.minWidth) ? o.minWidth : 0, maxWidth: p(o.maxWidth) ? o.maxWidth : 1 / 0, minHeight: p(o.minHeight) ? o.minHeight : 0, maxHeight: p(o.maxHeight) ? o.maxHeight : 1 / 0 };
                (this._aspectRatio || t) &&
                ...
                if (this._proportionallyResizeElements.length)
                    for (var t = this.helper || this.element, e = 0; e < this._proportionallyResizeElements.length; e++) {
                        ...
                        ((i = [n.css("borderTopWidth"), n.css("borderRightWidth"), n.css("borderBottomWidth"), n.css("borderLeftWidth")]),
                            ...
                            (this.borderDif = f.map(i, function (t, e) {
                                return (parseInt(t, 10) || 0) + (parseInt(s[e], 10) || 0);
                            }))),
                        (f.browser.msie && (f(t).is(":hidden") || f(t).parents(":hidden").length)) ||
            ...
            _renderProxy: function () {
                var t,
                    ...
                    s = this.element,
                    n = this.options;
                (this.elementOffset = s.offset()),
                    this._helper
                        ? ((this.helper = this.helper || f('<div style="overflow:hidden;"></div>')),
                            (e = (t = f.browser.msie && f.browser.version < 7) ? 1 : 0),
                            (i = t ? 2 : -1),
                            this.helper
                ...
                start: function (t, e) {
                    ...
                    "object" != typeof s.alsoResize || s.alsoResize.parentNode
                        ...
                        : s.alsoResize.length
                            ...
                            : f.each(s.alsoResize, function (t) {
                                i(t);
                            });
                },
                resize: function (t, o) {
                    ...
                    "object" != typeof s.alsoResize || s.alsoResize.nodeType
                        ? i(s.alsoResize)
                        : f.each(s.alsoResize, function (t, e) {
                            i(t, e);
                        });
                },
                stop: function (t, e) {
            ...
            f.ui.plugin.add("resizable", "containment", {
                start: function (t, e) {
                    var i,
                        ...
                        a,
                        l,
                        h = f(this).data("resizable"),
                        c = h.options,
                        u = h.element,
                        d = c.containment,
                        p = d instanceof f ? d.get(0) : /parent/.test(d) ? u.parent().get(0) : d;
                    p &&
                    ((h.containerElement = f(p)),
                        /document/.test(d) || d == document
                            ? ((h.containerOffset = { left: 0, top: 0 }),
                                (h.containerPosition = { left: 0, top: 0 }),
                                (h.parentData = { element: f(document), left: 0, top: 0, width: f(document).width(), height: f(document).height() || document.body.parentNode.scrollHeight }))
                            : ((i = f(p)),
                                (s = []),
                                ...
                                (h.containerSize = { height: i.innerHeight() - s[3], width: i.innerWidth() - s[1] }),
                                (n = h.containerOffset),
                                (o = h.containerSize.height),
                                (r = h.containerSize.width),
                                (a = f.ui.hasScroll(p, "left") ? p.scrollWidth : r),
                                (l = f.ui.hasScroll(p) ? p.scrollHeight : o),
                                (h.parentData = { element: p, left: n.left, top: n.top, width: a, height: l })));
                },
                resize: function (t, e) {
                    var i = f(this).data("resizable"),
                        s = i.options,
                    ...
                    return (
                        ...
                        l < r && ((t = l), (l = r), (r = t)),
                            ...
                            this.selectees.each(function () {
                                var t,
                                    e = h.data(this, "selectable-item");
                                e &&
                                e.element != s.element[0] &&
                                ((t = !1),
                                    "touch" == n.tolerance ? (t = !(e.left > a || e.right < o || e.top > l || e.bottom < r)) : "fit" == n.tolerance && (t = e.left > o && e.right < a && e.top > r && e.bottom < l),
                                    t
                                        ? (e.selected && (e.$element.removeClass("ui-selected"), (e.selected = !1)),
                                        e.unselecting && (e.$element.removeClass("ui-unselecting"), (e.unselecting = !1)),
                                        e.selecting || (e.$element.addClass("ui-selecting"), (e.selecting = !0), s._trigger("selecting", i, { selecting: e.element })))
                                        : (e.selecting &&
                                        ((i.metaKey || i.ctrlKey) && e.startselected
                                            ? (e.$element.removeClass("ui-selecting"), (e.selecting = !1), e.$element.addClass("ui-selected"), (e.selected = !0))
                                            : (e.$element.removeClass("ui-selecting"),
                                                (e.selecting = !1),
                                            e.startselected && (e.$element.addClass("ui-unselecting"), (e.unselecting = !0)),
                                                s._trigger("unselecting", i, { unselecting: e.element }))),
                                        !e.selected ||
                                        i.metaKey ||
                                        i.ctrlKey ||
                                        e.startselected ||
                                        (e.$element.removeClass("ui-selected"), (e.selected = !1), e.$element.addClass("ui-unselecting"), (e.unselecting = !0), s._trigger("unselecting", i, { unselecting: e.element }))));
                            }),
                            !1
                    );
                }
    ...
    (function (d) {
        d.widget("ui.sortable", d.ui.mouse, {
            ...
            _mouseStop: function (t, e) {
                ...
                if (t)
                    return (
                        d.ui.ddmanager && !this.options.dropBehaviour && d.ui.ddmanager.drop(this, t),
                            this.options.revert
            ...
            _refreshItems: function (t) {
                ...
                for (n = i.length - 1; 0 <= n; n--)
                    for (var l = i[n][1], h = i[n][0], r = 0, c = h.length; r < c; r++) {
                        var u = d(h[r]);
            ...
            refreshPositions: function (t) {
                ...
                for (var e = this.items.length - 1; 0 <= e; e--) {
                    ...
                    ((i = this.options.toleranceElement ? d(this.options.toleranceElement, s.item) : s.item), t || ((s.width = i.outerWidth()), (s.height = i.outerHeight())), (n = i.offset()), (s.left = n.left), (s.top = n.top));
                }
            ...
            _createPlaceholder: function (t) {
                ...
                ((i = n.placeholder),
                    (n.placeholder = {
                        element: function () {
                            var t = d(document.createElement(s.currentItem[0].nodeName))
                        ...
                        update: function (t, e) {
                            ...
                            (e.height() || e.height(s.currentItem.innerHeight() - parseInt(s.currentItem.css("paddingTop") || 0, 10) - parseInt(s.currentItem.css("paddingBottom") || 0, 10)),
                            e.width() || e.width(s.currentItem.innerWidth() - parseInt(s.currentItem.css("paddingLeft") || 0, 10) - parseInt(s.currentItem.css("paddingRight") || 0, 10)));
                        },
                    })),
                    (s.placeholder = d(n.placeholder.element.call(s.element, s.currentItem))),
                ...
                if (e)
                    if (1 === this.containers.length) this.containers[i]._trigger("over", t, this._uiHash(this)), (this.containers[i].containerCache.over = 1);
                        ...
                        for (var n, o = 1e4, r = null, a = this.positionAbs[this.containers[i].floating ? "left" : "top"], l = this.items.length - 1; 0 <= l; l--) {
                            d.ui.contains(this.containers[i].element[0], this.items[l].item[0]) &&
                            ((n = this.containers[i].floating ? this.items[l].item.offset().left : this.items[l].item.offset().top),
                            Math.abs(n - a) < o && ((o = Math.abs(n - a)), (r = this.items[l]), (this.direction = 0 < n - a ? "down" : "up")));
                        }
            ...
            _setContainment: function () {
                ...
                (this.containment = [
                    ...
                    d("document" == s.containment ? document : window).width() - this.helperProportions.width - this.margins.left,
                    (d("document" == s.containment ? document : window).height() || document.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top,
                ]),
                ...
                ((t = d(s.containment)[0]),
                    ...
                    (this.containment = [
                        e.left + (parseInt(d(t).css("borderLeftWidth"), 10) || 0) + (parseInt(d(t).css("paddingLeft"), 10) || 0) - this.margins.left,
                        e.top + (parseInt(d(t).css("borderTopWidth"), 10) || 0) + (parseInt(d(t).css("paddingTop"), 10) || 0) - this.margins.top,
                        e.left +
            ...
            _generatePosition: function (t) {
                ...
                return (
                    this.originalPosition &&
                    (this.containment &&
                    (t.pageX - this.offset.click.left < this.containment[0] && (r = this.containment[0] + this.offset.click.left),
                    ...
                    e.grid &&
                    ((n = this.originalPageY + Math.round((a - this.originalPageY) / e.grid[1]) * e.grid[1]),
                        (a =
                            this.containment && (n - this.offset.click.top < this.containment[1] || n - this.offset.click.top > this.containment[3])
                                ? n - this.offset.click.top < this.containment[1]
                                    ? n + e.grid[1]
                                    : n - e.grid[1]
                                : n),
                        (o = this.originalPageX + Math.round((r - this.originalPageX) / e.grid[0]) * e.grid[0]),
                        (r =
                            this.containment && (o - this.offset.click.left < this.containment[0] || o - this.offset.click.left > this.containment[2])
        ...
        h.extend(h.easing, {
            ...
            easeInElastic: function (t, e, i, s, n) {
                ...
                return 0 == e
                    ...
                    : 1 == (e /= n)
                        ? i + s
                        : ((r = r || 0.3 * n), (o = a < Math.abs(s) ? ((a = s), r / 4) : (r / (2 * Math.PI)) * Math.asin(s / a)), -(a * Math.pow(2, 10 * --e) * Math.sin((2 * (e * n - o) * Math.PI) / r)) + i);
            },
            easeOutElastic: function (t, e, i, s, n) {
                ...
                return 0 == e
                    ...
                    : 1 == (e /= n)
                        ? i + s
                        : ((r = r || 0.3 * n), (o = a < Math.abs(s) ? ((a = s), r / 4) : (r / (2 * Math.PI)) * Math.asin(s / a)), a * Math.pow(2, -10 * e) * Math.sin((2 * (e * n - o) * Math.PI) / r) + s + i);
            },
            easeInOutElastic: function (t, e, i, s, n) {
                ...
                return 0 == e
                    ...
                    : 2 == (e /= n / 2)
                        ? i + s
                        : ((r = r || 0.3 * n * 1.5),
                            (o = a < Math.abs(s) ? ((a = s), r / 4) : (r / (2 * Math.PI)) * Math.asin(s / a)),
                            e < 1 ? -0.5 * a * Math.pow(2, 10 * --e) * Math.sin((2 * (e * n - o) * Math.PI) / r) + i : a * Math.pow(2, -10 * --e) * Math.sin((2 * (e * n - o) * Math.PI) / r) * 0.5 + s + i);
            },
    ...
    (function (f) {
        f.effects.bounce = function (p) {
            return this.queue(function () {
                ...
                "hide" == i && (n /= 2 * o),
                "hide" != i && o--,
                "show" == i && (((h = { opacity: 1 })[a] = ("pos" == l ? "+=" : "-=") + n), t.animate(h, r / 2, p.options.easing), (n /= 2), o--);
                for (var h, c = 0; c < o; c++) {
                    var u,
                        d = {};
                ...
                "hide" == i
                    ? (((h = { opacity: 0 })[a] = ("pos" == l ? "-=" : "+=") + n),
                        t.animate(h, r / 2, p.options.easing, function () {
                            t.hide(), f.effects.restore(t, e), f.effects.removeWrapper(t), p.callback && p.callback.apply(this, arguments);
                        }))
                    : ((d = {}),
                        ((u = {})[a] = ("pos" == l ? "-=" : "+=") + n),
                        (d[a] = ("pos" == l ? "+=" : "-=") + n),
                        t.animate(u, r / 2, p.options.easing).animate(d, r / 2, p.options.easing, function () {
        ...
        (g.effects.puff = function (o) {
            ...
            (g.effects.size = function (f) {
                return this.queue(function () {
                    ...
                    (e.from = f.options.from || d),
                        (e.to = f.options.to || d),
                    u &&
                    ((t = g.effects.getBaseline(u, d)),
                        (e.from.top = (d.height - e.from.height) * t.y),
                        (e.from.left = (d.width - e.from.width) * t.x),
                        (e.to.top = (d.height - e.to.height) * t.y),
                        (e.to.left = (d.width - e.to.width) * t.x));
                    var p = { from: { y: e.from.height / d.height, x: e.from.width / d.width }, to: { y: e.to.height / d.height, x: e.to.width / d.width } };
                    ("box" != c && "both" != c) ||
                    (p.from.y != p.to.y && ((i = i.concat(r)), (e.from = g.effects.setTransition(e, r, p.from.y, e.from)), (e.to = g.effects.setTransition(e, r, p.to.y, e.to))),
                    p.from.x != p.to.x && ((i = i.concat(a)), (e.from = g.effects.setTransition(e, a, p.from.x, e.from)), (e.to = g.effects.setTransition(e, a, p.to.x, e.to)))),
                    ("content" != c && "both" != c) || p.from.y == p.to.y || ((i = i.concat(o)), (e.from = g.effects.setTransition(e, o, p.from.y, e.from)), (e.to = g.effects.setTransition(e, o, p.to.y, e.to))),
                        g.effects.save(e, h ? i : s),
                        e.show(),
                        g.effects.createWrapper(e),
                        e.css("overflow", "hidden").css(e.from),
                    ("content" != c && "both" != c) ||
                    ((r = r.concat(["marginTop", "marginBottom"]).concat(o)),
                        (a = a.concat(["marginLeft", "marginRight"])),
                        (n = i.concat(r).concat(a)),
                        e.find("*[width]").each(function () {
                            ...
                            p.from.y != p.to.y && ((t.from = g.effects.setTransition(t, r, p.from.y, t.from)), (t.to = g.effects.setTransition(t, r, p.to.y, t.to))),
                            p.from.x != p.to.x && ((t.from = g.effects.setTransition(t, a, p.from.x, t.from)), (t.to = g.effects.setTransition(t, a, p.to.x, t.to))),
                                t.css(t.from),
        ...
        d.widget("ui.accordion", {
            ...
            _create: function () {
                var t,
                    ...
                    s = i.options;
                (i.running = 0),
                    i.element.addClass("ui-accordion ui-widget ui-helper-reset").children("li").addClass("ui-accordion-li-fix"),
                    (i.headers = i.element
                        .find(s.header)
                    ...
                    i.headers.next().addClass("ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom"),
                !s.navigation || ((t = i.element.find("a").filter(s.navigationFilter).eq(0)).length && ((e = t.closest(".ui-accordion-header")).length ? (i.active = e) : (i.active = t.closest(".ui-accordion-content").prev()))),
                    (i.active = i
                        ._findActive(i.active || s.active)
                        .addClass("ui-state-default ui-state-active")
                        .toggleClass("ui-corner-all")
                        .toggleClass("ui-corner-top")),
                    i.active.next().addClass("ui-accordion-content-active"),
                    i._createIcons(),
                    i.resize(),
                    i.element.attr("role", "tablist"),
                    i.headers
                        .attr("role", "tab")
                    ...
                    i.headers
                        ...
                        .next()
                        .hide(),
                    i.active.length ? i.active.attr({ "aria-expanded": "true", "aria-selected": "true", tabIndex: 0 }) : i.headers.eq(0).attr("tabIndex", 0),
                d.browser.safari || i.headers.find("a").attr("tabIndex", -1),
                s.event &&
                i.headers.bind(s.event.split(" ").join(".accordion ") + ".accordion", function (t) {
            ...
            resize: function () {
                ...
                return (
                    i.fillSpace
                        ? (d.browser.msie && ((e = this.element.parent().css("overflow")), this.element.parent().css("overflow", "hidden")),
                            (t = this.element.parent().height()),
                        d.browser.msie && this.element.parent().css("overflow", e),
            ...
            _clickHandler: function (t, e) {
                ...
                if (!i.disabled)
                    if (t.target) {
                        var s,
                            n,
                            o = d(t.currentTarget || e),
                            r = o[0] === this.active[0];
                        (i.active = (!i.collapsible || !r) && this.headers.index(o)),
                        this.running ||
                        (!i.collapsible && r) ||
                        ((s = this.active),
                            (h = o.next()),
                            (a = this.active.next()),
                            (l = { options: i, newHeader: r && i.collapsible ? d([]) : o, oldHeader: this.active, newContent: r && i.collapsible ? d([]) : h, oldContent: a }),
                            (n = this.headers.index(this.active[0]) > this.headers.index(o[0])),
                            (this.active = r ? d([]) : o),
                            this._toggle(h, a, l, r, n),
                            s.removeClass("ui-state-active ui-corner-top").addClass("ui-state-default ui-corner-all").children(".ui-icon").removeClass(i.icons.headerSelected).addClass(i.icons.header),
                        r ||
                        (o.removeClass("ui-state-default ui-corner-all").addClass("ui-state-active ui-corner-top").children(".ui-icon").removeClass(i.icons.header).addClass(i.icons.headerSelected),
            ...
            _toggle: function (t, e, i, s, n) {
                ...
                o._trigger("changestart", null, o.data),
                    (o.running = 0 === e.size() ? t.size() : e.size()),
                    r.animated
                        ? ((l = {}),
                        ...
                        r.proxiedDuration || (r.proxiedDuration = r.duration),
                            ...
                            (h = d.ui.accordion.animations),
                            (c = r.duration),
                        !(u = r.animated) || h[u] || d.easing[u] || (u = "slide"),
                        h[u] ||
                        (h[u] = function (t) {
                            this.slide(t, { easing: u, duration: c || 700 });
                        }),
                            h[u](l))
                        : (r.collapsible && s ? t.toggle() : (e.hide(), t.show()), a(!0)),
                    e.prev().attr({ "aria-expanded": "false", "aria-selected": "false", tabIndex: -1 }).blur(),
            ...
            _completed: function (t) {
                ...
                this.toHide.length && this.toHide.parent()[0].className,
            ...
            d.extend(d.ui.accordion, {
                ...
                animations: {
                    slide: function (s, t) {
                        var e, i, n, o, r, a;
                        (s = d.extend({ easing: "swing", duration: 300 }, s, t)).toHide.size()
                            ? s.toShow.size()
                                ? ((e = s.toShow.css("overflow")),
                                    (i = 0),
                                    (n = {}),
                                    (o = {}),
                                    (r = s.toShow),
                                ...
                                : s.toHide.animate({ height: "hide", paddingTop: "hide", paddingBottom: "hide" }, s)
                            : s.toShow.animate({ height: "show", paddingTop: "show", paddingBottom: "show" }, s);
                    },
    ...
    (function (n) {
        n.widget("ui.menu", {
            ...
            activate: function (t, e) {
                ...
                this.deactivate(),
                this.hasScroll() &&
                ((i = e.offset().top - this.element.offset().top), (s = this.element.scrollTop()), (n = this.element.height()), i < 0 ? this.element.scrollTop(s + i) : n <= i && this.element.scrollTop(s + i - n + e.height())),
        ...
        o.widget("ui.button", {
                                ...
                                .bind("mousedown.button", function () {
                                    return (
                                        ...
                                        (o(this).addClass("ui-state-active"),
                                            (l = this),
                                            void o(document).one("mouseup", function () {
                                                l = null;
                                            }))
                                    );
                                })
            ...
            _determineButtonType: function () {
                ...
                this.element.is(":checkbox") ? (this.type = "checkbox") : this.element.is(":radio") ? (this.type = "radio") : this.element.is("input") ? (this.type = "input") : (this.type = "button"),
                    "checkbox" === this.type || "radio" === this.type
                        ? ((t = this.element.parents().filter(":last")),
            ...
            destroy: function () {
                this.element.removeClass("ui-helper-hidden-accessible"),
                    this.buttonElement
                        .removeClass(d + " ui-state-hover ui-state-active  " + p)
                        .removeAttr("role")
            ...
            _resetButton: function () {
                var t, e, i, s, n;
                "input" !== this.type
                    ? ((t = this.buttonElement.removeClass(p)),
    ...
    (function ($, undefined) {
        ...
        $.extend(Datepicker.prototype, {
                ...
                ((n = this._get(e, "buttonText")),
                    ...
                    (e.trigger = $(
                        this._get(e, "buttonImageOnly")
                            ? $("<img/>").addClass(this._triggerClass).attr({ src: o, alt: n, title: n })
                            : $('<button type="button"></button>')
                                .addClass(this._triggerClass)
                                .html("" == o ? n : $("<img/>").attr({ src: o, alt: n, title: n }))
                    )),
            ...
            _autoSize: function (t) {
                ...
                (i = this._get(t, "dateFormat")).match(/[DM]/) &&
                ((s = function (t) {
            ...
            _enableDatepicker: function (e) {
                ...
                ("input" == (t = e.nodeName.toLowerCase())
                    ...
                    : ("div" != t && "span" != t) || ((i = s.children("." + this._inlineClass)).children().removeClass("ui-state-disabled"), i.find("select.ui-datepicker-month, select.ui-datepicker-year").removeAttr("disabled")),
            ...
            _disableDatepicker: function (e) {
                ...
                ("input" == (t = e.nodeName.toLowerCase())
                    ...
                    : ("div" != t && "span" != t) || ((i = s.children("." + this._inlineClass)).children().addClass("ui-state-disabled"), i.find("select.ui-datepicker-month, select.ui-datepicker-year").attr("disabled", "disabled")),
                    (this._disabledInputs = $.map(this._disabledInputs, function (t) {
                        return t == e ? null : t;
                    })),
            ...
            _optionDatepicker: function (t, e, i) {
                ...
                (this._curInst == s && this._hideDatepicker(),
                    ...
                    extendRemove(s.settings, a),
                null !== o && a.dateFormat !== undefined && a.minDate === undefined && (s.settings.minDate = this._formatDate(s, o)),
                null !== r && a.dateFormat !== undefined && a.maxDate === undefined && (s.settings.maxDate = this._formatDate(s, r)),
            ...
            _showDatepicker: function (t) {
                ...
                !1 !== (s = (e = $.datepicker._get(i, "beforeShow")) ? e.apply(t, [t, i]) : {}) &&
                ...
                i.inline ||
                ((r = $.datepicker._get(i, "showAnim")),
                    (a = $.datepicker._get(i, "duration")),
                    (l = function () {
                        var t,
                            e = i.dpDiv.find("iframe.ui-datepicker-cover");
                        e.length && ((t = $.datepicker._getBorders(i.dpDiv)), e.css({ left: -t[0], top: -t[1], width: i.dpDiv.outerWidth(), height: i.dpDiv.outerHeight() }));
                    }),
            ...
            _updateDatepicker: function (t) {
                ...
                1 < o && t.dpDiv.addClass("ui-datepicker-multi-" + o).css("width", 17 * o + "em"),
            ...
            _hideDatepicker: function (t) {
                ...
                (this._datepickerShowing &&
                    ((e = this._get(o, "showAnim")),
                        ...
                        $.effects && $.effects[e] ? o.dpDiv.hide(e, $.datepicker._get(o, "showOptions"), i, s) : o.dpDiv["slideDown" == e ? "slideUp" : "fadeIn" == e ? "fadeOut" : "hide"](e ? i : null, s),
                    e || s(),
                        (this._datepickerShowing = !1),
            ...
            _selectDay: function (t, e, i, s) {
                ...
                (((n = this._getInst(o[0])).selectedDay = n.currentDay = $("a", s).html()),
            ...
            parseDate: function (i, o, t) {
                ...
                for (
                    var a = "string" != typeof (a = (t ? t.shortYearCutoff : null) || this._defaults.shortYearCutoff) ? a : (new Date().getFullYear() % 100) + parseInt(a, 10),
            ...
            _generateHTML: function (t) {
                var e = new Date(),
                    ...
                    f = t.drawYear;
                if ((p < 0 && ((p += 12), f--), d))
                    for (var g = this._daylightSavingAdjust(new Date(d.getFullYear(), d.getMonth() - r[0] * r[1] + 1, d.getDate())), g = u && g < u ? u : g; this._daylightSavingAdjust(new Date(f, p, 1)) > g; ) --p < 0 && ((p = 11), f--);
                ...
                for (
                    var m = this._get(t, "prevText"),
                        ...
                        v = this._canAdjustMonth(t, -1, f, p)
                        ...
                        b = this._canAdjustMonth(t, 1, f, p)
                    ...
                    for (var H = 0; H < r[1]; H++) {
                        var L = this._daylightSavingAdjust(new Date(f, p, t.selectedDay)),
                            ...
                            W = "";
                        if (h) {
                            if (((W += '<div class="ui-datepicker-group'), 1 < r[1]))
                                switch (H) {
                                    case 0:
                        ...
                        W +=
                            ...
                            R +
                            '">' +
                            (/all|left/.test(R) && 0 == O ? (i ? b : v) : "") +
                            (/all|right/.test(R) && 0 == O ? (i ? v : b) : "") +
                            this._generateMonthYearHeader(t, p, f, u, d, 0 < O || 0 < H, I, T) +
                        ...
                        for (var K = this._daylightSavingAdjust(new Date(f, p, 1 - Q)), X = 0; X < V; X++) {
                            ...
                            for (var G = D ? '<td class="ui-datepicker-week-col">' + this._get(t, "calculateWeek")(K) + "</td>" : "", q = 0; q < 7; q++) {
                                var Z = F ? F.apply(t.input ? t.input[0] : null, [K]) : [!0, ""],
                                    J = K.getMonth() != p,
                                    tt = (J && !P) || !Z[0] || (u && K < u) || (d && d < K);
                                (G +=
                                    '<td class="' +
                                    (5 <= (q + k + 6) % 7 ? " ui-datepicker-week-end" : "") +
                                    (J ? " ui-datepicker-other-month" : "") +
                                    ((K.getTime() == L.getTime() && p == t.selectedMonth && t._keyEvent) || (M.getTime() == K.getTime() && M.getTime() == L.getTime()) ? " " + this._dayOverClass : "") +
                                    (tt ? " " + this._unselectableClass + " ui-state-disabled" : "") +
                                    (J && !A ? "" : " " + Z[1] + (K.getTime() == c.getTime() ? " " + this._currentClass : "") + (K.getTime() == e.getTime() ? " ui-datepicker-today" : "")) +
                                    '"' +
                                    ((J && !A) || !Z[2] ? "" : ' title="' + Z[2] + '"') +
                                    ...
                                    (J && !A
                                        ...
                                        : tt
                                            ...
                                            (K.getTime() == c.getTime() ? " ui-state-active" : "") +
            ...
            _generateMonthYearHeader: function (t, e, i, s, n, o, r, a) {
                ...
                if ((c || (u += d + (!o && l && h ? "" : "&#xa0;")), !t.yearshtml))
                    if (((t.yearshtml = ""), o || !h)) u += '<span class="ui-datepicker-year">' + i + "</span>";
                        ...
                        for (t.yearshtml += '<select class="ui-datepicker-year" data-handler="selectYear" data-event="change">'; b <= y; b++)
    ...
    (function (g) {
        ...
        (g.fn.position = function (h) {
            ...
            return (
                ...
                1 === p.length && (p[1] = p[0]),
                    ...
                    "right" === h.at[0] ? (f.left += c) : h.at[0] === m && (f.left += c / 2),
                    "bottom" === h.at[1] ? (f.top += u) : h.at[1] === m && (f.top += u / 2),
                    (f.left += p[0]),
                    (f.top += p[1]),
                    this.each(function () {
                        var i,
                        ...
                        v.fractions || ((l.left = Math.round(l.left)), (l.top = Math.round(l.top))),
                            ...
                            g.each(["left", "top"], function (t, e) {
                                g.ui.position[d[t]] && g.ui.position[d[t]][e](l, { targetWidth: c, targetHeight: u, elemWidth: s, elemHeight: n, collisionPosition: i, collisionWidth: r, collisionHeight: a, offset: p, my: h.my, at: h.at });
                            }),
        ...
        ((g.offset.setOffset = function (t, e) {
            ...
            (function () {
                ...
                o.appendChild(n),
                    (t = s || document.documentElement).insertBefore(o, t.firstChild),
                    ...
                    (o.innerHTML = ""),
                    t.removeChild(o),
                    (i = e.top + e.left + (s ? 2e3 : 0)),
                    (v.fractions = 21 < i && i < 22);
            })();
    })(jQuery),
    (function (i) {
    ...
    (function (c) {
        c.widget("ui.slider", c.ui.mouse, {
            ...
            _change: function (t, e) {
                ...
                this._keySliding ||
                this._mouseSliding ||
                ((i = { handle: this.handles[e], value: this.value() }), this.options.values && this.options.values.length && ((i.value = this.values(e)), (i.values = this.values())), this._trigger("change", t, i));
            },
            value: function (t) {
        ...
        p.widget("ui.tabs", {
                ...
                (this.list = this.element.find("ol,ul").eq(0)),
                    ...
                    this.anchors.each(function (t, e) {
                        var i,
                            ...
                            o = p(e).attr("href"),
                            r = o.split("#")[0];
                        r && (r === location.toString().split("#")[0] || ((i = p("base")[0]) && r === i.href)) && ((o = e.hash), (e.href = o)),
                            h.test(o)
                                ? (a.panels = a.panels.add(a.element.find(a._sanitizeSelector(o))))
                                : o && "#" !== o
                                    ? (p.data(e, "href.tabs", o),
                                        p.data(e, "load.tabs", o.replace(/#.*$/, "")),
                                        (s = a._tabId(e)),
                                        (e.href = "#" + s),
                                    (n = a.element.find("#" + s)).length ||
                                    (n = p(l.panelTemplate)
                                        .attr("id", s)
                        ...
                        ? function (t, e) {
                            p(t).closest("li").addClass("ui-tabs-selected ui-state-active"),
                                e
                                    ...
                                    .animate(r, r.duration || "normal", function () {
            ...
            load: function (s) {
                ...
                var t,
                    ...
                    e = p.data(r, "load.tabs");
                if ((this.abort(), e && (0 === this.element.queue("tabs").length || !p.data(r, "cache.tabs"))))
                    return (
                        this.lis.eq(s).addClass("ui-state-processing"),
                        o.spinner && (t = p("span", r)).data("label.tabs", t.html()).html(o.spinner),
                            (this.xhr = p.ajax(
        ...
        u.each("branch form header step wrapper".split(" "), function () {
            ...
            u.widget("kf." + p, {
                ...
                _transition: function (t, e, i) {
                    ...
                    var n = s.options,
                        o = s.step(t, e),
                        r = o.attr(n.stateAttribute),
                        a = r ? n.transitions[r] : n.transitions[f],
                        l = u.isFunction(a)
                            ? a.call(s, o, function () {
                                        ...
                                        !0,
                                        {
                                            ...
                                            success: function (t) {
                                                ...
                                                var e,
                                                    ...
                                                    n = !0 === t || "true" === t;
                                                n
                                                    ? ((e = l.formSubmitted), l.prepareElement(r), (l.formSubmitted = e), l.successList.push(r), delete l.invalid[r.name], l.showErrors())
                                                    : ((i = {}), (s = t || l.defaultMessage(r, "remote")), (i[r.name] = a.message = h.isFunction(s) ? s(o) : s), (l.invalid[r.name] = !0), l.showErrors(i)),
                                                    (a.valid = n),
                                                    l.stopRequest(r, n);
                                            },
                                        },
        ...
        (e.prototype = {
            ...
            loop_: function (t, e) {
                for (var i, s, n = this, o = 0; o < n.el_.length; ++o) {
                    void 0 === n.selectors_[o] &&
                    ((s = ":not(" + (i = n.extend_({}, n.defaults_, n.options_, n.el_[o].getAttribute("data-options"))).exclude.split(/[\s,]+/).join("):not(") + ")"),
                        (n.selectors_[o] = i.transform.replace(/,/g, s + ",") + s),
                        (n.config_[o] = i));
